...
return new class extends Migration
{
    ...
    {
        Schema::create('mihong_gold_prices', function (Blueprint $table) {
            $table->id();
            $table->string('brand');
            ...
            $table->decimal('buy_change', 15, 2)->default(0);
            $table->decimal('sell_change', 15, 2)->default(0);
    ...
    {
        Schema::dropIfExists('mihong_gold_prices');
    }
};
