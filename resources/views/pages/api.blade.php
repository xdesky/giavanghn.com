...
<div class="glass-card p-4 md:p-6">
    ...
    <p class="text-sm text-slate-600 mb-4">Truy cập dữ liệu giá vàng theo thời gian thực thông qua REST API. Phù hợp cho ứng dụng tài chính, bot giao dịch và báo điện tử.</p>
