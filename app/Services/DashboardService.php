        ...
        return [
            ...
            'variants' => [
                'spot' => [
                    ...
                    'price' => $usBase,
                    'unit' => 'USD/Ounce',
                    'dayChangeLabel' => sprintf('%+.2f hôm nay', $xau ? $xau->change_amount : 12.3),
                ],
                'future' => [
                    'label' => 'Giá Future (COMEX)',
                    'price' => $usBase + 4.35,
                    'unit' => 'USD/Ounce',
                    'dayChangeLabel' => sprintf('%+.2f hôm nay', ($xau ? $xau->change_amount : 14.1) + 1.8),
                ],
                'london' => [
                    'label' => 'London Fix PM',
                    'price' => $usBase - 3.5,
                    'unit' => 'USD/Ounce',
                    'dayChangeLabel' => sprintf('%+.2f hôm nay', ($xau ? $xau->change_amount : 10.5) - 1.8),
                ],
            ],
            'selected' => 'spot',
