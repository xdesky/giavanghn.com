...
<div class="rounded-sm border border-[#bcbcbc] bg-gradient-to-br from-amber-50/80 to-pink-50/80 p-4 md:p-6">
    ...
    <h2 class="text-lg sm:text-2xl font-bold text-[#001061] mb-4">So sánh giá vàng SJC và Ngọc Thẩm hôm nay</h2>
    ...
    <div class="grid gap-5 sm:grid-cols-2 mb-4">
        ...
        <div class="rounded-sm border-2 border-pink-300 bg-white p-4 text-center">
            ...
            <p class="text-xl sm:text-3xl font-bold text-pink-900 tabular-nums">{{ number_format($otherSell * 1e6, 0, ',', '.') }}</p>
            <p class="text-xs text-slate-500 mb-1">VNĐ/Lượng</p>
            <div class="flex items-center justify-center gap-3 text-xs">
