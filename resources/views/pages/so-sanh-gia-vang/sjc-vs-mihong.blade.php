...
@php
    ...
    $otherCard = $snapshot['mihongCard'] ?? null;
    $otherName = 'Mi Hồng';
    $otherColor = '#ea580c';
    $otherSlug = 'mihong';
...
<script type="application/ld+json">
{
    ...
    "mainEntity": [
        ...
        {"@@type":"Question","name":"Nên mua vàng ở SJC hay Mi Hồng?","acceptedAnswer":{"@@type":"Answer","text":"Mi Hồng có giá vàng nhẫn 9999 và vàng ta cạnh tranh, phù hợp cho người mua tại TP.HCM. SJC có lợi thế về vàng miếng SJC 1 lượng với thanh khoản cao nhất toàn quốc. Nếu ở TP.HCM và muốn giá tốt nhất, kiểm tra cả hai trước khi giao dịch."}},
        {"@@type":"Question","name":"Tiệm vàng Mi Hồng ở đâu?","acceptedAnswer":{"@@type":"Answer","text":"Mi Hồng là tiệm vàng truyền thống nổi tiếng tại khu vực Chợ Lớn, quận 5, TP.HCM. Đây là một trong những tiệm vàng lâu đời nhất Sài Gòn, được biết đến với giá vàng cạnh tranh và uy tín trong cộng đồng người Hoa."}},
        {"@@type":"Question","name":"Vàng Mi Hồng có uy tín không?","acceptedAnswer":{"@@type":"Answer","text":"Mi Hồng là tiệm vàng lâu đời và uy tín tại Chợ Lớn, TP.HCM. Mặc dù quy mô nhỏ hơn các tập đoàn lớn, Mi Hồng được tin tưởng nhờ giá cả minh bạch, chất lượng vàng đảm bảo và phục vụ lâu năm."}}
    ]
}
</script>
@endpush
...
<div class="rounded-sm border border-[#bcbcbc] bg-gradient-to-br from-amber-50/80 to-orange-50/80 p-4 md:p-6">
    ...
    <h2 class="text-lg sm:text-2xl font-bold text-[#001061] mb-4">So sánh giá vàng SJC và Mi Hồng hôm nay</h2>
    ...
    <div class="grid gap-5 sm:grid-cols-2 mb-4">
        ...
        <div class="rounded-sm border-2 border-orange-300 bg-white p-4 text-center">
            <p class="text-sm font-semibold text-orange-700 mb-1">{{ $otherName }} (bán ra)</p>
            <p class="text-xl sm:text-3xl font-bold text-orange-900 tabular-nums">{{ number_format($otherSell * 1e6, 0, ',', '.') }}</p>
            <p class="text-xs text-slate-500 mb-1">VNĐ/Lượng</p>
            <div class="flex items-center justify-center gap-3 text-xs">
        ...
        <table class="w-full text-sm">
            <thead class="bg-slate-50">
                <tr>
                    ...
                    <th class="p-3 text-right font-semibold text-orange-700">{{ $otherName }} Mua</th>
                    <th class="p-3 text-right font-semibold text-orange-700">{{ $otherName }} Bán</th>
...
<article class="rounded-sm border border-[#bcbcbc] bg-white p-4 md:p-6 prose prose-sm max-w-none prose-headings:text-[#001061] prose-p:text-slate-700">
    <h2 class="!mt-0">Phân tích so sánh giá vàng SJC và Mi Hồng</h2>

    <h3>Mi Hồng — Tiệm vàng truyền thống Chợ Lớn</h3>
    <p><strong>Mi Hồng</strong> là tiệm vàng truyền thống nổi tiếng tại khu vực Chợ Lớn, quận 5, TP.HCM. Đây là một trong những tiệm vàng lâu đời nhất Sài Gòn, gắn liền với cộng đồng người Hoa và văn hóa buôn bán vàng tại khu vực này:</p>
    <ul>
        <li><strong>Giá cạnh tranh miền Nam:</strong> Mi Hồng thường niêm yết giá vàng ở mức cạnh tranh nhất khu vực TP.HCM, đặc biệt vàng nhẫn 9999 và vàng ta.</li>
        <li><strong>Giao dịch truyền thống:</strong> Phong cách giao dịch nhanh gọn, phục vụ cả khách lẻ và khách sỉ.</li>
        <li><strong>Đa dạng sản phẩm:</strong> Ngoài vàng miếng SJC, Mi Hồng kinh doanh vàng nhẫn 9999, vàng ta 990, vàng 18K và vàng trang sức.</li>
    </ul>

    <h3>SJC — Thanh khoản số 1 toàn quốc</h3>
    <p>Vàng miếng SJC là chuẩn mực của thị trường vàng Việt Nam. Với mạng lưới giao dịch rộng khắp, vàng SJC có thể mua bán tại bất kỳ ngân hàng hay tiệm vàng nào. Tuy nhiên giá SJC thường cao hơn giá nhẫn 9999 tại Mi Hồng.</p>

    <h3>Đặc thù mua vàng tại Chợ Lớn</h3>
    <p>Khu vực Chợ Lớn (quận 5, TP.HCM) là "phố vàng" truyền thống của Sài Gòn với hàng chục tiệm vàng tập trung. Giá vàng tại đây thường cạnh tranh hơn so với các hệ thống lớn do mô hình tiệm vàng gia đình với chi phí vận hành thấp. Mi Hồng là một trong những tiệm vàng uy tín nhất khu vực.</p>

    <h3>Khi nào chọn SJC, khi nào chọn Mi Hồng?</h3>
    <ul>
        <li><strong>Mua vàng SJC miếng:</strong> Cả hai đều bán vàng miếng SJC — so sánh giá bán để chọn nơi rẻ hơn.</li>
        <li><strong>Mua vàng nhẫn 9999:</strong> Mi Hồng thường có giá tốt, phù hợp tích trữ.</li>
        <li><strong>Mua vàng ta, vàng 18K:</strong> Mi Hồng có thế mạnh về các sản phẩm vàng truyền thống mà SJC không chuyên.</li>
        <li><strong>Ở TP.HCM:</strong> Mi Hồng thuận tiện cho người ở khu vực quận 5, Chợ Lớn.</li>
    </ul>

    <h3>So sánh spread</h3>
    <p>Hiện tại: SJC spread <strong>{{ number_format($sjcSpread, 0, ',', '.') }} VNĐ</strong> vs Mi Hồng <strong>{{ number_format($otherSpread, 0, ',', '.') }} VNĐ</strong>. Mi Hồng có spread linh hoạt, phụ thuộc vào biến động thị trường trong ngày.</p>
</article>
