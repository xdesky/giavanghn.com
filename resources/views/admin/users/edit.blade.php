    ...
    <div class="container-site px-6 py-8">
        <div class="max-w-2xl mx-auto">
            <div class="mb-6 flex items-center gap-3">
                ...
                <h1 class="text-2xl font-bold text-slate-800">Sửa người dùng</h1>
            </div>
            ...
            <form action="{{ route('admin.users.update', $user) }}" method="POST" class="bg-white rounded-sm border border-slate-200 p-6 space-y-5">
                @csrf
                @method('PUT')
                ...
                <div>
                    <label for="password" class="block text-sm font-semibold text-slate-700 mb-1">Mật khẩu mới <span class="text-xs text-slate-400">(để trống nếu không đổi)</span></label>
