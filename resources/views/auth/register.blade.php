...
<head>
    ...
    <title>Đăng ký - Giá Vàng Hôm Nay</title>
...
<body class="m-0 font-sans text-[#333] bg-white min-h-screen flex flex-col">
    ...
    <div class="w-full max-w-md">
        ...
        <div class="text-center mb-8">
            ...
            <p class="text-slate-600">Đăng ký để nhận thông báo giá vàng miễn phí</p>
        </div>

        <!-- Register Card -->
        <div class="bg-white rounded-sm shadow-xl border border-[#bcbcbc] p-8">
            <h2 class="text-2xl font-bold text-slate-900 mb-6">Tạo tài khoản</h2>
            ...
            <form action="{{ route('register') }}" method="POST">
                ...
                <div class="mb-4">
                    <label for="phone" class="block text-sm font-semibold text-slate-700 mb-2">Số điện thoại (không bắt buộc)</label>
                ...
                <div class="mb-4">
                    ...
                    <input type="password" id="password" name="password" required 
                           class="w-full px-4 py-3 rounded-sm border border-slate-300 focus:border-blue-500 focus:ring-2 focus:ring-blue-200 transition">
                    <p class="mt-1 text-xs text-slate-500">Tối thiểu 8 ký tự</p>
                </div>
            ...
            <div class="mt-6">
                <div class="relative">
                    ...
                    <div class="relative flex justify-center text-sm">
                        <span class="px-4 bg-white text-slate-500">Hoặc đăng ký bằng</span>
                    </div>
                </div>
            ...
            <p class="mt-6 text-center text-sm text-slate-600">
                Đã có tài khoản? 
                <a href="{{ route('login') }}" class="text-blue-600 hover:text-blue-700 font-semibold">Đăng nhập</a>
            </p>
        </div>
